    ...
    return (
      <PageTransition className="h-full w-full">
        <div className="relative flex w-full items-center justify-center">
          <div className="relative flex h-[440px] w-full items-center justify-center overflow-hidden rounded-[2rem] border border-primary/10 bg-[#0F172A] sm:h-[520px]">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_35%,rgba(37,99,235,0.16),transparent_35%),radial-gradient(circle_at_20%_80%,rgba(20,184,166,0.1),transparent_30%]" />
            ...
            <div className="absolute top-[190px] h-72 w-72 animate-[spin_18s_linear_infinite] rounded-full border border-primary/10" />
            <div className="absolute top-[210px] h-60 w-60 animate-[spin_12s_linear_infinite_reverse] rounded-full border border-primary/10" />
            <div className="absolute top-[240px] h-40 w-40 rounded-full border border-primary/20" />

            <div className="absolute top-[265px] h-24 w-24 animate-pulse rounded-full bg-secondary/20 blur-2xl" />
            <div className="absolute top-[280px] h-14 w-14 rounded-full border border-secondary/40 bg-secondary/20 shadow-[0_0_45px_rgba(20,184,166,0.45)]" />

            <div className="absolute left-8 top-[200px] animate-[float_4s_ease-in-out_infinite] rounded-full border border-primary/20 bg-black/60 px-3 py-1.5 font-mono text-xs text-secondary backdrop-blur-md">React</div>
            <div className="absolute right-8 top-[245px] animate-[float_5s_ease-in-out_infinite_1s] rounded-full border border-primary/20 bg-black/60 px-3 py-1.5 font-mono text-xs text-secondary backdrop-blur-md">Next.js</div>
            <div className="absolute bottom-36 left-10 animate-[float_6s_ease-in-out_infinite_2s] rounded-full border border-primary/20 bg-black/60 px-3 py-1.5 font-mono text-xs text-secondary backdrop-blur-md">TypeScript</div>
            <div className="absolute bottom-28 right-10 animate-[float_4.5s_ease-in-out_infinite_0.5s] rounded-full border border-primary/20 bg-black/60 px-3 py-1.5 font-mono text-xs text-secondary backdrop-blur-md">Three.js</div>
            ...
            <div className="absolute bottom-10 w-[70%] text-center">
              ...
              <div className="mt-4 h-[2px] w-full overflow-hidden bg-white/10">
                <div className="h-full bg-gradient-to-r from-primary to-secondary shadow-[0_0_18px_rgba(37,99,235,0.7)] transition-all duration-300" style={{ width: `${progress}%` }} />
              </div>
            </div>
          </div>
        </div>
  ...
  return (
    <PageTransition className="h-full w-full">
      <div className="relative flex h-full min-h-[560px] w-full items-center justify-center">
        <section className="relative h-[min(680px,calc(100vh-9rem))] min-h-[540px] w-full overflow-hidden rounded-[2rem] border border-white/10 bg-[#0F172A]">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_35%,rgba(37,99,235,0.14),transparent_34%),radial-gradient(circle_at_20%_75%,rgba(20,184,166,0.09),transparent_30%),radial-gradient(circle_at_80%_20%,rgba(94,234,212,0.08),transparent_28%)]" />
          ...
          <div className="pointer-events-none absolute bottom-12 right-10 z-20 w-[280px]">
            ...
            <div className="mt-5 h-[3px] w-full overflow-hidden bg-white/10">
              <div className="h-full bg-gradient-to-r from-primary to-secondary shadow-[0_0_22px_rgba(37,99,235,0.6)] transition-all duration-300" style={{ width: `${progress}%` }} />
            </div>
          ...
          <div className="absolute inset-0 z-10 cursor-grab active:cursor-grabbing">
            <Canvas camera={{ position: [0, 0, 7.2], fov: 55 }} gl={{ antialias: true, alpha: true, powerPreference: "high-performance" }} dpr={[1, 1.8]}>
              ...
              <pointLight position={[-6, -4, -6]} intensity={1.4} color="#2563EB" />
              <pointLight position={[0, 0, 4]} intensity={0.95} color="#14B8A6" />
